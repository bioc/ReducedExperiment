...
#' me_1 <- identify_modules(airway_se, verbose = 0, power = estimated_power)
#' me_1
#'
...
#' name of the assay to be subject to WGCNA.
#'
#' @param powerVector A vector of integers indicating soft-thresholding powers
#' to be assessed. See \link[WGCNA]{pickSoftThreshold}.
#'
#' @param RsquaredCut The minimum scale free topology fitting index required.
#' Used to select the soft-thresholding power.
#' See \link[WGCNA]{pickSoftThreshold}.
#'
...
#' "signed" or "signed hybrid". See \link[WGCNA]{pickSoftThreshold} for
#' more details.
#'
#' @param maxBlockSize The chunk size (in terms of the number of features/genes)
#' to process the data. See \link[WGCNA]{pickSoftThreshold} for
...
#'
#' @param verbose The verbosity, passed to \link[WGCNA]{pickSoftThreshold}.
#'
#' @param ... Additional arguments to be passed to
#' \link[WGCNA]{pickSoftThreshold}.
#'
#' @returns Returns a `data.frame` generated by \link[WGCNA]{pickSoftThreshold}
...
#' selecting the lowest value that with
...
#' specified, however, we additionally ensure that the selected power
