...
high-dimensional omics data types. Among these, the SingleCellExperiment 
package is particularly notable as it provides the `reducedDims` slot for 
...
Factor 6 is enriched for the pathway
"WP_NETWORK_MAP_OF_SARSCOV2_SIGNALING_PATHWAY".

```{r example-factor-enrichment}
rownames(factor_6_enrich) <- NULL
factor_6_enrich[, c("ID", "pvalue", "p.adjust", "geneID")]
```
