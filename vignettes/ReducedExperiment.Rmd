...
stability_res <- estimate_stability(
    wave1_se,
    n_runs = 10,
    min_components = 10, max_components = 50, by = 5,
...
Note that, the above plot was generated for the small test data we are using
for the purposes of this vignette, so the stability profile is not 
representative of what you'll likely see for real data. We also include the
image below, demonstrating a stability profile generated for the full dataset.
