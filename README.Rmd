...
Then install `ReducedExperiment` from [Bioconductor](http://bioconductor.org/) 
...
Alternatively, the development version of `ReducedExperiment` is available from [GitHub](https://github.com/jackgisby/ReducedExperiment) with:
...
```{r estimate_factors, eval=requireNamespace('ReducedExperiment'), message=FALSE, warning=FALSE}
